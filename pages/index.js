...
export default function Home() {
  return (
    ...
    >
      <h2 className="text-5xl py-3">hi, I'm  </h2>
      <br/>
       <h2 className="text-5xl text-teal-500 py-3 px-2 ">Mouli S</h2>
    </span>
          
          <h3 className="text-5xl  py-3">Web Developer and Designer</h3>
       
 

          <p className="text-medium text-gray-200 py-3">
            Freelancer providing for programming and design content needs.Join me down below and let's get cracking!
          </p>
         
        </div>
        <div className="text-4xl flex justify-center gap-5 py-3 text-gray-500">
      ...
      <div>
        <h1 className="text-4xl  py-3 mt-20  text-center"> My Skills</h1>
      ...
      <div>
      <h1 className="text-4xl  py-3 mt-20  text-center">Experience & Education</h1>
      <hr  className=" h-1 w-24  text-center mx-auto border-none bg-teal-500 mb-20"/>
      ...
      <div className=" grid grid-cols-1 md:grid-cols-3 gap-10">
       ...
       <div className="text-center shadow-lg p-10 rounded-xl my-10 bg-teal-500 hover:animate-bounce hover:opacity-60">
          ...
          <h3 className="text-2xl pt-8 pb-2">Platos Academy Higher Seconday School</h3>
...
<p className="text-gray-300 py-2">year-2023 Jan to March</p>
      ...
      <div className=" shadow-lg  mt-10">
       <h1 className="text-4xl  py-3 mt-20  text-center">Projects</h1>
       <hr  className=" h-1 w-24  text-center mx-auto border-none bg-teal-500 mb-20"/>
     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-10 m-20 ">
      <a href="https://facepreparation.netlify.app/">
       <div className="  shadow-lg">
        ...
        <Image  className="bg-white hover:scale-125 duration-1000"src={design}/>
        </div>
        <h3 className="py-2 text-xl text-teal-500">Login Page</h3>
        <p className="py-2 text-md text-gray-400">Technology Used-React</p>
      ...
      <a href="https://github.com/MouliSri/NotesApp">
       <div className=" shadow-lg">
        <div className="overflow-hidden">
        <Image  className="bg-white hover:scale-125 duration-1000"src={notes} height={150} width={150}/>
        </div>
      ...
      <a href="https://moulisri.github.io/dog/">
       <div className=" shadow-lg">
        <div className="overflow-hidden">
        <Image  className="bg-white hover:scale-125 duration-1000"src={dog} height={200} width={200}/>
        </div>
        <h3 className="py-2 text-xl text-teal-500">Dogs Website</h3>
        <p className="py-2 text-md text-gray-400">Technology used-Html, Css, JavaScript</p>
       </div>
       </a>
       ...
       <div className=" shadow-lg">
        <div className="overflow-hidden">
        <Image  className="bg-white hover:scale-125 duration-1000"src={code}/>
        </div>
        <h3 className="py-2 text-xl text-teal-500">TodoList</h3>
        <p className="py-2 text-md text-gray-400">Technology used-Nodejs,Express,mongoDb</p>
       </div>
       </a>
